...
<template>
  <div class="min-h-[80vh] px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
    ...
    <!-- Header gradient -->
    <div class="rounded-2xl bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 p-[1px] shadow-lg">
      <div class="rounded-2xl bg-white/80 dark:bg-zinc-900/70 backdrop-blur">
        <div class="flex items-center gap-3 px-6 py-5">
          <div class="h-10 w-10 rounded-xl bg-white/70 dark:bg-white/10 flex items-center justify-center shadow">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 opacity-80" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 12c2.7 0 4.8-2.1 4.8-4.8S14.7 2.4 12 2.4 7.2 4.5 7.2 7.2 9.3 12 12 12zM12 14.4c-3.6 0-10.8 1.8-10.8 5.4v1.8h21.6v-1.8c0-3.6-7.2-5.4-10.8-5.4z"/>
            </svg>
          </div>
          <div class="flex-1">
    ...
    <div class="mt-6">
      ...
      <!-- Error -->
      <div v-else-if="errorMsg" class="rounded-2xl bg-red-50 border border-red-200 text-red-700 px-5 py-4">
        {{ errorMsg }}
      </div>
      ...
      <div v-else-if="user" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <!-- aura -->
          <div class="pointer-events-none absolute -inset-1 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
               style="background: radial-gradient(600px circle at var(--x,50%) var(--y,50%), rgba(99,102,241,.15), transparent 40%);">
          </div>

          <div class="relative z-10 flex flex-col items-center text-center">
            <div class="relative">
              <img
                :src="user.profileImage || 'https://pbs.twimg.com/profile_images/1283676276314632193/D1Wnm-EW_400x400.jpg'"
                alt="Profile"
            ...
            <transition name="fade">
              <div v-if="isEditing" class="w-full mt-4">
                <label class="block text-sm font-medium text-zinc-600 mb-1">New Profile Image URL</label>
                <input
                  v-model="newImageUrl"
                  type="text"
                  placeholder="https://..."
        ...
        <div class="lg:col-span-2 rounded-2xl bg-white shadow-lg ring-1 ring-zinc-100 p-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-xs px-2 py-1 rounded-full border"
                  :class="isEditing ? 'bg-amber-50 text-amber-700 border-amber-200' : 'bg-emerald-50 text-emerald-700 border-emerald-200'">
