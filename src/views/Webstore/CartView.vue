          ...
          <div class="cartpage-summary bg-gray-50 rounded-lg p-6 mt-8">
            ...
            <div class="mt-6 flex flex-col md:flex-row gap-2">
              ...
              <button
                ...
                class="w-full px-6 py-3 bg-black text-white rounded-full font-semibold hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                <svg
                ...
                <span>{{ cartStore.isCheckingOut ? 'Processing...' : 'Checkout Now' }}</span>
              </button>
            </div>
          </div>
        </div>
